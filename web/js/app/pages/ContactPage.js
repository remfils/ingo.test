...
export default class ContactPage extends React.Component {
        ...
        if ( this.props.movies ) {
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    TweenLite.set($("#ContactPage"), {opacity: 0});

                    if (this.props.onAjaxLoaded)
                        this.props.onAjaxLoaded(() => {
                            TweenLite.to($("#ContactPage"), 1, {opacity: 1});
                        });
                },
                error: (err) => {
    ...
    leaveToMoviePage(callback) {
        ...
        tl.to($current_image, 1, {x: "-=100%", ease: Power2.easeOut})
            .to($("#ContactPage"), 1, {x: "-=100%", ease: Power2.easeInOut, onComplete:()=>{
                ...
                <TitleColoredTable className="title-project-dsc" color={color} direction={this.state.movement_direction}>
                    ...
                    <tr>
                        <td class="title-footer">
                            ++ Ingo Scheel Kameramann I DOP f?r: Imagefilm I Werbung I Spielfilm I Dokumentarfilm I K?ln ++
                        </td>
                    </tr>
                </TitleColoredTable>
